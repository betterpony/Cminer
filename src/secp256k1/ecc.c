...
#define Curve_P_32 {0xfffffffefffffc2full, 0xffffffffffffffffull, 0xffffffffffffffffull, 0xffffffffffffffffull}
...
#define Curve_N_32 {0xBFD25E8CD0364141ull, 0xBAAEDCE6AF48A03Bull, 0xFFFFFFFFFFFFFFFEull,0xFFFFFFFFFFFFFFFFull}
...
int ecc_make_key(uint8_t p_publicKey[ECC_BYTES * 2], uint8_t p_privateKey[ECC_BYTES])
{
    ...
    do
    {
        ...
        l_private[0] = 0x1e844774a88b6695;
        l_private[1] = 0x999cac42bff4fc40;
        l_private[2] = 0x9e289ebbc79a36e5;
        l_private[3] = 0x90b8c2622142a07d;
